...
- [ ] Phase ordering makes sense (Foundation → Drive → Slack → Calendar → Email → RAG)
- [ ] Decision points resolved: claude -p for transcripts, gmail.metadata first, @fullcalendar/react, Qdrant not pgvector for RAG

**Review this plan:** `file:///C:/Projects/conscia-fractional/kanban/1_planning/PLAN_2026-04-01_integrations-meeting-recording.md`
